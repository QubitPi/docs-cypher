...
Before creating a https://qubitpi.github.io/neo4j-docs-getting-started/getting-started/get-started-with-neo4j/graph-database/#property-graph[property graph] database, it is important to develop an appropriate data model.
...
image::introduction-schema.svg[Diagram showing the used data model,width=600,role=popup]
...
[NOTE]
The quantifier used in the above two examples was introduced with the release of xref::patterns/variable-length-patterns.adoc#quantified-path-patterns[quantified path patterns].
